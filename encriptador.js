...
const btnEncriptar = document.querySelector(".button__encriptar");
...
const btnCopiar = document.querySelector(".button__copiar");
const btnDesencriptar = document.querySelector(".button__desencriptar");
